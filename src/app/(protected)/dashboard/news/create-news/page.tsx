...
const CreateProductForm: React.FC = () => {
  ...
  const onSubmit = async (data: ProductFormValues) => {
    ...
    if (!data.name_ar || data.name_ar.trim() === "") {
      toast.error("يجب إدخال اسم المنتج بالعربية");
      return;
    }

    if (!data.name_en || data.name_en.trim() === "") {
      toast.error("يجب إدخال اسم المنتج بالإنجليزية");
      return;
    }
  ...
  return (
    <>
      <div className="mb-[25px] md:flex items-center justify-between">
        <h5 className="!mb-0">إنشاء منتج جديد</h5>
                ...
                <div className="sm:grid sm:grid-cols-2 sm:gap-[25px]">
                  ...
                  <div className="mb-[20px] sm:mb-0">
                    ...
                    <input
                      ...
                      id="name_ar"
                      {...register("name_ar", {
                        required: "يجب إدخال اسم المنتج بالعربية",
                        maxLength: {
                          value: 500,
                          message: "يجب ألا يزيد الاسم عن 500 حرف",
                        },
                      })}
                    />
                  ...
                  <div className="mb-[20px] sm:mb-0">
                    ...
                    <input
                      ...
                      id="name_en"
                      {...register("name_en", {
                        required: "يجب إدخال اسم المنتج بالإنجليزية",
                        maxLength: {
                          value: 500,
                          message: "يجب ألا يزيد الاسم عن 500 حرف",
                        },
